...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
        ...
        if (str == null) {
            ...
            while (i < i2) {
                ...
                if (charAt < 128) {
                    ...
                    if (charAt < 2048) {
                        writeByte((charAt >> 6) | ItemInfoWithIcon.FLAG_SYSTEM_MASK);
                        writeByte((int) (charAt & '?') | 128);
                    } else if (charAt < 55296 || charAt > 57343) {
                        writeByte((charAt >> 12) | SysUiStatsLog.BACK_GESTURE_REPORTED_REPORTED);
    ...
    public Buffer writeUtf8CodePoint(int i) {
        if (i < 128) {
            ...
            writeByte((i >> 6) | ItemInfoWithIcon.FLAG_SYSTEM_MASK);
            writeByte((i & 63) | 128);
        } else if (i < 65536) {
            if (i < 55296 || i > 57343) {
                writeByte((i >> 12) | SysUiStatsLog.BACK_GESTURE_REPORTED_REPORTED);
