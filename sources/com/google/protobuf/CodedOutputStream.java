    ...
    private static class ArrayEncoder extends CodedOutputStream {
        ...
        public final void writeUInt32NoTag(int i) throws IOException {
            if (!CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS || spaceLeft() < 10) {
                ...
                while ((i & -128) != 0) {
                    UnsafeUtil.putByte(this.buffer, access$200, (byte) ((i & WorkQueueKt.MASK) | 128));
                    this.position++;
                    i >>>= 7;
        ...
        public final void writeUInt64NoTag(long j) throws IOException {
            if (!CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS || spaceLeft() < 10) {
                ...
                long access$200 = CodedOutputStream.ARRAY_BASE_OFFSET + ((long) this.position);
                while ((j & -128) != 0) {
                    UnsafeUtil.putByte(this.buffer, access$200, (byte) ((((int) j) & WorkQueueKt.MASK) | 128));
                    this.position++;
                    j >>>= 7;
                    access$200 = 1 + access$200;
                }
    ...
    private static abstract class AbstractBufferedEncoder extends CodedOutputStream {
        ...
        public final void bufferUInt32NoTag(int i) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                long j = access$200;
                while ((i & -128) != 0) {
                    UnsafeUtil.putByte(this.buffer, j, (byte) ((i & WorkQueueKt.MASK) | 128));
                    i >>>= 7;
                    j = 1 + j;
                }
        ...
        public final void bufferUInt64NoTag(long j) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                long j2 = access$200;
                while ((j & -128) != 0) {
                    UnsafeUtil.putByte(this.buffer, j2, (byte) ((((int) j) & WorkQueueKt.MASK) | 128));
                    j >>>= 7;
                    j2 = 1 + j2;
                }
