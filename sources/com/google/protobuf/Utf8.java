...
final class Utf8 {
        ...
        public final void encodeUtf8Default(CharSequence charSequence, ByteBuffer byteBuffer) {
            ...
            while (i2 < length) {
                ...
                if (charAt2 < 128) {
                    ...
                    i = position + 1;
                    try {
                        byteBuffer.put(position, (byte) ((charAt2 >>> 6) | ItemInfoWithIcon.FLAG_SYSTEM_MASK));
                    ...
                    i = position + 1;
                    byteBuffer.put(position, (byte) ((charAt2 >>> 12) | SysUiStatsLog.BACK_GESTURE_REPORTED_REPORTED));
                    position = i + 1;
    ...
    static final class UnsafeProcessor extends Processor {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:14:0x003d A[LOOP:1: B:14:0x003d->B:38:0x0106, LOOP_START, PHI: r2 r3 r4 r11 
          ...
          PHI: (r4v5 long) = (r4v4 long), (r4v7 long) binds: [B:10:0x0034, B:38:0x0106] A[DONT_GENERATE, DONT_INLINE]
