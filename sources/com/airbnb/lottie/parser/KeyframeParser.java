...
class KeyframeParser {
    ...
    private static <T> com.airbnb.lottie.value.Keyframe<T> parseKeyframe(com.airbnb.lottie.LottieComposition r12, com.airbnb.lottie.parser.moshi.JsonReader r13, float r14, com.airbnb.lottie.parser.ValueParser<T> r15) throws java.io.IOException {
        ...
        L_0x009e:
            ...
            java.lang.ref.WeakReference r14 = new java.lang.ref.WeakReference     // Catch:{ ArrayIndexOutOfBoundsException -> 0x00b6 }
            r14.<init>(r1)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x00b6 }
            putInterpolator(r13, r14)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x00b6 }
        L_0x00b6:
            r7 = r1
            goto L_0x00bb
        L_0x00b8:
