...
public final class TestProtocol {
    ...
    public static final String REQUEST_GET_ACTIVITIES_CREATED_COUNT = "get-activities-created-count";
    public static final String REQUEST_GET_FOCUSED_TASK_HEIGHT_FOR_TABLET = "get-focused-task-height-for-tablet";
    public static final String REQUEST_GET_GRID_TASK_SIZE_RECT_FOR_TABLET = "get-grid-task-size-rect-for-tablet";
    ...
    public static final String REQUEST_ICON_HEIGHT = "icon-height";
    ...
    public static final String REQUEST_USE_DEFAULT_WORKSPACE_LAYOUT = "use-default-workspace-layout";
    ...
    public static String stateOrdinalToString(int i) {
        switch (i) {
            case 0:
                return "Normal";
            case 1:
