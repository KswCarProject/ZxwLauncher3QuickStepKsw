...
public final class ExtensionEmbeddingBackend implements EmbeddingBackend {
    ...
    public static final class SplitListenerWrapper {
            ...
            if (!Intrinsics.areEqual((Object) list2, (Object) this.lastValue)) {
                ...
                this.executor.execute(new Runnable(list2) {
                    ...
                    public final void run() {
                        ExtensionEmbeddingBackend.SplitListenerWrapper.m19accept$lambda1(ExtensionEmbeddingBackend.SplitListenerWrapper.this, this.f$1);
                    }
                });
            }
        }
        ...
        public static final void m19accept$lambda1(SplitListenerWrapper splitListenerWrapper, List list) {
