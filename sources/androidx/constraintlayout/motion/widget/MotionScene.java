...
public class MotionScene {
    ...
    private int getId(Context context, String str) {
        int i;
        if (str.contains("/")) {
            i = context.getResources().getIdentifier(str.substring(str.indexOf(47) + 1), FlagManager.EXTRA_ID, context.getPackageName());
    ...
    private void parseConstraintSet(Context context, XmlPullParser xmlPullParser) {
        ...
        for (int i3 = 0; i3 < attributeCount; i3++) {
            ...
            } else if (attributeName.equals(FlagManager.EXTRA_ID)) {
