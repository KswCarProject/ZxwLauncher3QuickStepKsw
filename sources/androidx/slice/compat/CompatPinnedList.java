...
public class CompatPinnedList {
    ...
    /* JADX WARNING: Unknown top exception splitter block from list: {B:13:0x0067=Splitter:B:13:0x0067, B:20:0x007f=Splitter:B:20:0x007f} */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized androidx.collection.ArraySet<androidx.slice.SliceSpec> getSpecs(android.net.Uri r7) {
        /*
            r6 = this;
            monitor-enter(r6)
            androidx.collection.ArraySet r0 = new androidx.collection.ArraySet     // Catch:{ all -> 0x0086 }
            r0.<init>()     // Catch:{ all -> 0x0086 }
            android.content.SharedPreferences r1 = r6.getPrefs()     // Catch:{ all -> 0x0086 }
            ...
            java.lang.String r3 = r7.toString()     // Catch:{ all -> 0x0086 }
            java.lang.StringBuilder r2 = r2.append(r3)     // Catch:{ all -> 0x0086 }
            java.lang.String r2 = r2.toString()     // Catch:{ all -> 0x0086 }
            r3 = 0
            java.lang.String r2 = r1.getString(r2, r3)     // Catch:{ all -> 0x0086 }
            ...
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ all -> 0x0086 }
            java.lang.String r7 = r7.toString()     // Catch:{ all -> 0x0086 }
            java.lang.StringBuilder r7 = r4.append(r7)     // Catch:{ all -> 0x0086 }
            java.lang.String r7 = r7.toString()     // Catch:{ all -> 0x0086 }
            java.lang.String r7 = r1.getString(r7, r3)     // Catch:{ all -> 0x0086 }
            boolean r1 = android.text.TextUtils.isEmpty(r2)     // Catch:{ all -> 0x0086 }
        ...
        L_0x004e:
            java.lang.String r1 = ","
            r3 = -1
            java.lang.String[] r1 = r2.split(r1, r3)     // Catch:{ all -> 0x0086 }
            java.lang.String r2 = ","
            java.lang.String[] r7 = r7.split(r2, r3)     // Catch:{ all -> 0x0086 }
            int r2 = r1.length     // Catch:{ all -> 0x0086 }
            int r3 = r7.length     // Catch:{ all -> 0x0086 }
            if (r2 == r3) goto L_0x0066
            androidx.collection.ArraySet r7 = new androidx.collection.ArraySet     // Catch:{ all -> 0x0086 }
        ...
        L_0x0066:
            r2 = 0
        L_0x0067:
            int r3 = r1.length     // Catch:{ all -> 0x0086 }
            if (r2 >= r3) goto L_0x007d
            androidx.slice.SliceSpec r3 = new androidx.slice.SliceSpec     // Catch:{ all -> 0x0086 }
            r4 = r1[r2]     // Catch:{ all -> 0x0086 }
            r5 = r7[r2]     // Catch:{ all -> 0x0086 }
            int r5 = java.lang.Integer.parseInt(r5)     // Catch:{ all -> 0x0086 }
