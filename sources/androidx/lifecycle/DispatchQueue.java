...
public final class DispatchQueue {
        ...
        if (immediate.isDispatchNeeded(coroutineContext) || canRun()) {
            immediate.dispatch(coroutineContext, new Runnable(runnable) {
                ...
                public final void run() {
                    DispatchQueue.m6dispatchAndEnqueue$lambda2$lambda1(DispatchQueue.this, this.f$1);
                }
            });
        } else {
            enqueue(runnable);
    ...
    public static final void m6dispatchAndEnqueue$lambda2$lambda1(DispatchQueue dispatchQueue, Runnable runnable) {
