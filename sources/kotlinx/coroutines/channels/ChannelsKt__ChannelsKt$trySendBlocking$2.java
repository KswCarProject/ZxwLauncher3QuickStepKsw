    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m132constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m132constructorimpl(Unit.INSTANCE);
        if (Result.m139isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m1592successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m1590closedJP2dKIU(Result.m135exceptionOrNullimpl(obj2));
        }
        return ChannelResult.m1577boximpl(obj3);
    }
}
