...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    public final Object m1568trySendJP2dKIU(E e) {
        Object offerInternal = offerInternal(e);
        if (offerInternal == AbstractChannelKt.OFFER_SUCCESS) {
            return ChannelResult.Companion.m1592successJP2dKIU(Unit.INSTANCE);
        }
        if (offerInternal == AbstractChannelKt.OFFER_FAILED) {
            ...
            return ChannelResult.Companion.m1590closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        } else if (offerInternal instanceof Closed) {
            return ChannelResult.Companion.m1590closedJP2dKIU(helpCloseAndGetSendException((Closed) offerInternal));
        } else {
    ...
    private final void helpClose(Closed<?> closed) {
        Object r2 = InlineList.m1614constructorimpl$default((Object) null, 1, (DefaultConstructorMarker) null);
        while (true) {
            ...
            if (receive == null) {
                ...
                r2 = InlineList.m1619plusFjFbRPM(r2, receive);
            }
        }
        if (r2 != null) {
    ...
    public final Object sendSuspend(E e, Continuation<? super Unit> continuation) {
        ...
        while (true) {
            ...
            if (offerInternal == AbstractChannelKt.OFFER_SUCCESS) {
                Result.Companion companion = Result.Companion;
                cancellableContinuation.resumeWith(Result.m132constructorimpl(Unit.INSTANCE));
                break;
