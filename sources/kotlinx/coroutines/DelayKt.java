...
public final class DelayKt {
    ...
    public static final Object m1556delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1557toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1557toDelayMillisLRDsOJo(long j) {
        if (Duration.m1417compareToLRDsOJo(j, Duration.Companion.m1520getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1436getInWholeMillisecondsimpl(j), 1);
        }
        return 0;
    }
}
