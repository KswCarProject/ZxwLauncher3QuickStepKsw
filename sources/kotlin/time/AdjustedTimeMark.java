...
final class AdjustedTimeMark extends TimeMark {
    ...
    public final long m1412getAdjustmentUwyO8pc() {
    ...
    public long m1411elapsedNowUwyO8pc() {
        return Duration.m1453minusLRDsOJo(this.mark.m1547elapsedNowUwyO8pc(), m1412getAdjustmentUwyO8pc());
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1413plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1454plusLRDsOJo(m1412getAdjustmentUwyO8pc(), j), (DefaultConstructorMarker) null);
    }
}
