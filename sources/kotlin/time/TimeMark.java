...
public abstract class TimeMark {
    ...
    public abstract long m1547elapsedNowUwyO8pc();

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1549plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this, j, (DefaultConstructorMarker) null);
    }

    /* renamed from: minus-LRDsOJo  reason: not valid java name */
    public TimeMark m1548minusLRDsOJo(long j) {
        return m1549plusLRDsOJo(Duration.m1470unaryMinusUwyO8pc(j));
    }

    public final boolean hasPassedNow() {
        return !Duration.m1451isNegativeimpl(m1547elapsedNowUwyO8pc());
    }
