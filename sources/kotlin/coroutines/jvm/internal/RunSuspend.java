...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m1319getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object obj) {
        synchronized (this) {
            this.result = Result.m131boximpl(obj);
            notifyAll();
    ...
    public final void await() {
        synchronized (this) {
            while (true) {
                Result<Unit> r0 = m1319getResultxLWZpok();
                if (r0 == null) {
                    wait();
                } else {
                    ResultKt.throwOnFailure(r0.m141unboximpl());
                }
            }
        }
    }
